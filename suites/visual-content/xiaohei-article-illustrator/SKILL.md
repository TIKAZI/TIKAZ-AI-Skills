---
name: xiaohei-article-illustrator
description: Art-direct concise hand-drawn Chinese article illustrations from an article thesis using a small dark character, white space, sparse color annotations, visual metaphor, shot cards, and publishing-size QA. Use for conceptual article images, workflow metaphors, knowledge posts, and explanatory editorial illustrations.
---
...
2. Choose one mechanism or metaphor and write a shot card: message, scene, composition, character action, labels, palette, forbidden elements, and alt text.
3. Use a mostly white hand-drawn field, one small dark character as guide rather than mascot wallpaper, and sparse red/orange/blue annotations only where they clarify causality.
